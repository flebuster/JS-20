...
const textWhat = document.querySelector('.what');
...
const textWhy = document.querySelector('.why');
...
making it look like readable English. Manydesktop publishing
packagdives and web page editors now use Lorem Ipsum as their
...
const textWhereDoes = document.querySelector('.where__does');

textWhereDoes.innerHTML = `
<h2>
...
const textWhereCan = document.querySelector('.where__can');

textWhereCan.innerHTML = `
<h2>
